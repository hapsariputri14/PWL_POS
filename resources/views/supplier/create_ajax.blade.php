    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="supplier_nama" name="supplier_nama" value="" required>
            ...
            <div class="form-group">
                <label>Telepon</label>
                <input type="text" class="form-control" id="supplier_telp" name="supplier_telp" value="" required>
