    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importUserLabel">Import Data User</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <small id="error-user_data" class="error-text form-text text-danger"></small>
                </div>
                <!-- Input File -->
                <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status) {
                        ...
                        tableUser.ajax.reload(); // ganti ini sesuai ID DataTable user
                    } else {
                        $('.error-text').text('');
